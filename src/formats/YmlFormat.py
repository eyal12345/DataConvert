...
class YmlFormat(FormatProcess, IFormat):

    def __init__(self, frame, path: str, datasets: list[dict]) -> None:
        """
        constructor for YmlFormat object
        attributes:
    ...
    def write_data_to_file(self) -> None:
        with open(self.path, "w", encoding='utf8') as file:
            yaml.dump(self.results, file, default_flow_style=False, allow_unicode=True, sort_keys=False)
